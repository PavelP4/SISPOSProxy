...
6. Configure the logger (if you need it). By default it cofigured to log into the "Windows Logs". There is a commented configuration to log into file.	
	
7. Run InstallService.bat as administrator to register the proxy windows service (UninstallService.bat to unisrall)

8. Open the windows services console, find SIS POS Proxy service and start it. Restart the service each time his settings are changed.
